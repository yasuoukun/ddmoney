...
const allProductsData = [
    ...
    { name: 'iPhone 12 128GB (มือสอง)', installments: { '9': '1,240', '6': '1,560', '4': '2,110', '3': '2,650' } },
    { name: 'iPhone 12 64GB (มือสอง)', installments: { '9': '1,100', '6': '1,390', '4': '1,870', '3': '2,360' } },
    
    // Used iPhone 11 Series
    { name: 'iPhone 11 Pro Max 64GB (มือสอง)', installments: { '9': '960', '6': '1,210', '4': '1,640', '3': '2,060' } },
    { name: 'iPhone 11 Pro 64GB (มือสอง)', installments: { '9': '820', '6': '1,040', '4': '1,400', '3': '1,770' } },
    
    // iPad Series
    { name: 'iPad Gen 11 128GB WiFi', installments: { '12': '1,690', '10': '1,990', '9': '2,330', '6': '2,950', '4': '3,980', '3': '5,010' } },
    { name: 'iPad Gen 11 256GB WiFi', installments: { '12': '2,080', '10': '2,460', '9': '2,880', '6': '3,640', '4': '4,910', '3': '6,190' } },
    { name: 'iPad Gen 11 128GB Cellular', installments: { '12': '2,280', '10': '2,690', '9': '3,160', '6': '3,990', '4': '5,380', '3': '6,780' } },
    { name: 'iPad Gen 11 256GB Cellular', installments: { '12': '2,680', '10': '3,160', '9': '3,710', '6': '4,680', '4': '6,320', '3': '7,960' } },
    { name: 'iPad Mini 7 128GB WiFi', installments: { '12': '2,180', '10': '2,570', '9': '3,020', '6': '3,810', '4': '5,150', '3': '6,480' } },
    { name: 'iPad Mini 7 256GB WiFi', installments: { '12': '2,580', '10': '3,040', '9': '3,570', '6': '4,510', '4': '6,080', '3': '7,660' } },
    { name: 'iPad Air 6 128GB WiFi 13"', installments: { '12': '2,480', '10': '2,930', '9': '3,430', '6': '4,330', '4': '5,850', '3': '7,370' } },
    { name: 'iPad Air 7 128GB WiFi 11"', installments: { '12': '2,480', '10': '2,930', '9': '3,430', '6': '4,330', '4': '5,850', '3': '7,370' } },
    { name: 'iPad Air 7 256GB WiFi 11"', installments: { '12': '2,970', '10': '3,510', '9': '4,120', '6': '5,200', '4': '7,020', '3': '8,840' } },
    { name: 'iPad Air 7 128GB Cell 11"', installments: { '12': '3,070', '10': '3,630', '9': '4,250', '6': '5,370', '4': '7,250', '3': '9,130' } },
    { name: 'iPad Air 7 256GB Cell 11" (ราคาพิเศษ)', installments: { '12': '2,480', '10': '2,930', '9': '3,430', '6': '4,330', '4': '5,850', '3': '7,370' } },
    { name: 'iPad Air 8 128GB WiFi 11"', installments: { '12': '2,780', '10': '3,280', '9': '3,840', '6': '4,850', '4': '6,550', '3': '8,250' } },
    { name: 'iPad Air 8 256GB WiFi 11"', installments: { '12': '3,370', '10': '3,980', '9': '4,670', '6': '5,890', '4': '7,960', '3': '10,020' } },
    { name: 'iPad Air 8 128GB Cell 11"', installments: { '12': '3,370', '10': '3,980', '9': '4,670', '6': '5,890', '4': '7,960', '3': '10,020' } },
    { name: 'iPad Air 7 256GB Cell 11"', installments: { '12': '3,770', '10': '4,450', '9': '5,210', '6': '6,590', '4': '8,890', '3': '11,200' } },
    
    // Used iPad Series
    { name: 'iPad Gen 8 32GB WiFi (มือสอง)', installments: { '9': '460', '6': '580', '4': '790', '3': '990' } },
    { name: 'iPad Gen 8 128GB WiFi (มือสอง)', installments: { '9': '550', '6': '690', '4': '930', '3': '1,180' } },
    { name: 'iPad Gen 9 64GB WiFi (มือสอง)', installments: { '9': '690', '6': '870', '4': '1,170', '3': '1,470' } },
    { name: 'iPad Gen 9 256GB WiFi (มือสอง)', installments: { '9': '820', '6': '1,040', '4': '1,400', '3': '1,770' } },
    { name: 'iPad Gen 10 64GB WiFi (มือสอง)', installments: { '10': '1,050', '9': '1,240', '6': '1,560', '4': '2,110', '3': '2,650' } },
    { name: 'iPad Gen 10 256GB WiFi (มือสอง)', installments: { '10': '1,170', '9': '1,370', '6': '1,730', '4': '2,340', '3': '2,950' } },
    { name: 'iPad Gen 11 128GB WiFi (มือสอง)', installments: { '10': '1,520', '9': '1,790', '6': '2,250', '4': '3,040', '3': '3,830' } },
    { name: 'iPad Gen 11 256GB WiFi (มือสอง)', installments: { '10': '1,760', '9': '2,060', '6': '2,600', '4': '3,510', '3': '4,430' } },
    { name: 'iPad Air 4 64GB WiFi (มือสอง)', installments: { '10': '1,050', '9': '1,240', '6': '1,560', '4': '2,110', '3': '2,650' } },
    { name: 'iPad Air 4 256GB WiFi (มือสอง)', installments: { '10': '1,170', '9': '1,370', '6': '1,730', '4': '2,340', '3': '2,950' } },
    { name: 'iPad Air 5 64GB WiFi (มือสอง)', installments: { '10': '1,170', '9': '1,370', '6': '1,730', '4': '2,340', '3': '2,950' } },
    { name: 'iPad Air 5 256GB WiFi (มือสอง)', installments: { '10': '1,290', '9': '1,510', '6': '1,910', '4': '2,570', '3': '3,240' } },
    { name: 'iPad Air 6 128GB WiFi 11" (มือสอง)', installments: { '10': '1,640', '9': '1,920', '6': '2,430', '4': '3,280', '3': '4,130' } },
    { name: 'iPad Air 6 256GB WiFi 11" (มือสอง)', installments: { '10': '1,760', '9': '2,060', '6': '2,600', '4': '3,510', '3': '4,430' } },
    { name: 'iPad Air 6 128GB WiFi 13" (มือสอง)', installments: { '10': '1,870', '9': '2,200', '6': '2,770', '4': '3,750', '3': '4,720' } },
    { name: 'iPad Air 6 256GB WiFi 13" (มือสอง)', installments: { '10': '1,990', '9': '2,340', '6': '2,950', '4': '3,980', '3': '5,020' } },
    { name: 'iPad Air 7 128GB WiFi 11" (มือสอง)', installments: { '10': '2,110', '9': '2,470', '6': '3,120', '4': '4,210', '3': '5,310' } },
    { name: 'iPad Air 7 256GB WiFi 11" (มือสอง)', installments: { '10': '2,220', '9': '2,610', '6': '3,290', '4': '4,450', '3': '5,610' } },
    { name: 'iPad Air 7 128GB WiFi 13" (มือสอง)', installments: { '10': '2,220', '9': '2,610', '6': '3,290', '4': '4,450', '3': '5,610' } },
    { name: 'iPad Air 7 256GB WiFi 13" (มือสอง)', installments: { '10': '2,690', '9': '3,160', '6': '3,990', '4': '5,390', '3': '6,790' } },
    { name: 'iPad Air 8 128GB WiFi 11" (มือสอง)', installments: { '10': '2,690', '9': '3,160', '6': '3,990', '4': '5,390', '3': '6,790' } },
    { name: 'iPad Air 8 256GB WiFi 11" (มือสอง)', installments: { '10': '2,930', '9': '3,440', '6': '4,340', '4': '5,850', '3': '7,380' } },
    { name: 'iPad Air 8 128GB WiFi 13" (มือสอง)', installments: { '10': '2,930', '9': '3,440', '6': '4,340', '4': '5,850', '3': '7,380' } },
    { name: 'iPad Air 8 256GB WiFi 13" (มือสอง)', installments: { '10': '3,160', '9': '3,710', '6': '4,680', '4': '6,320', '3': '7,970' } },
    { name: 'iPad Pro 11 2018 64GB WiFi (มือสอง)', installments: { '10': '1,170', '9': '1,370', '6': '1,730', '4': '2,340', '3': '2,950' } },
    { name: 'iPad Pro 11 2018 256GB WiFi (มือสอง)', installments: { '10': '1,290', '9': '1,510', '6': '1,910', '4': '2,570', '3': '3,240' } },
    { name: 'iPad Pro 11 M1 128GB WiFi (มือสอง)', installments: { '10': '2,110', '9': '2,470', '6': '3,120', '4': '4,210', '3': '5,310' } },
    { name: 'iPad Pro 11 M1 256GB WiFi (มือสอง)', installments: { '10': '2,220', '9': '2,610', '6': '3,290', '4': '4,450', '3': '5,610' } },
    { name: 'iPad Pro 11 M2 128GB WiFi (มือสอง)', installments: { '10': '2,340', '9': '2,750', '6': '3,470', '4': '4,680', '3': '5,900' } },
    { name: 'iPad Pro 11 M2 256GB WiFi (มือสอง)', installments: { '10': '2,460', '9': '2,890', '6': '3,640', '4': '4,920', '3': '6,200' } },
    { name: 'iPad Pro 11 M3 128GB WiFi (มือสอง)', installments: {} },
    { name: 'iPad Pro 11 M3 256GB WiFi (มือสอง)', installments: { '10': '2,580', '9': '3,020', '6': '3,820', '4': '5,150', '3': '6,490' } },
    { name: 'iPad Pro 11 M4 128GB WiFi (มือสอง)', installments: {} },
    { name: 'iPad Pro 11 M4 256GB WiFi (มือสอง)', installments: { '10': '2,690', '9': '3,160', '6': '3,990', '4': '5,390', '3': '6,790' } },
    { name: 'iPad Pro 11 M5 128GB WiFi (มือสอง)', installments: {} },
    { name: 'iPad Pro 11 M5 256GB WiFi (มือสอง)', installments: { '10': '3,860', '9': '4,540', '6': '5,720', '4': '7,730', '3': '9,740' } }
];
